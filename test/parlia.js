...
contract("Parlia", async (accounts) => {
  ...
  it("can add or remove validator", async () => {
    ...
    const res1 = await parlia.addValidator('0x00A601f45688DbA8a070722073B015277cF36725', '0x00A601f45688DbA8a070722073B015277cF36725')
  ...
  it("remove firstly added validator", async () => {
    const {parlia} = await newMockContract(owner)
    await parlia.addValidator('0x0000000000000000000000000000000000000001', '0x0000000000000000000000000000000000000001')
    await parlia.addValidator('0x0000000000000000000000000000000000000002', '0x0000000000000000000000000000000000000002')
    await parlia.addValidator('0x0000000000000000000000000000000000000003', '0x0000000000000000000000000000000000000003')
