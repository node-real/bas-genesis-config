...
contract("Staking", async (accounts) => {
  ...
  it("staker can do simple delegation", async () => {
    ...
    await parlia.addValidator(validator1, validator1);
  ...
  it("undelegate should work on existing delegation", async () => {
    const {parlia} = await newMockContract(owner)
    await parlia.addValidator(validator1, validator1);
    await parlia.addValidator(validator2, validator2);
    await parlia.delegate(validator1, {from: staker1, value: '1000000000000000000'}); // +1.0
  ...
  it("active validator set depends on staked amount", async () => {
    ...
    await parlia.addValidator(validator1, validator1); // 0x821aEa9a577a9b44299B9c15c88cf3087F3b5544
    await parlia.addValidator(validator2, validator2); // 0x0d1d4e623D10F9FBA5Db95830F7d3839406C6AF2
    await parlia.addValidator(validator3, validator3); // 0x2932b7A2355D6fecc4b5c0B6BD44cC31df247a2e
    await parlia.addValidator(validator4, validator4); // 0x2191eF87E392377ec08E7c08Eb105Ef5448eCED5
    await parlia.addValidator(validator5, validator5); // 0x0F4F2Ac550A1b4e2280d04c21cEa7EBD822934b5
    // delegate
    await parlia.delegate(validator1, {from: staker1, value: '3000000000000000000'}); // 3.0
    await parlia.delegate(validator2, {from: staker2, value: '2000000000000000000'}); // 2.0
  ...
  it("stake to non-existing validator", async () => {
    const {parlia} = await newMockContract(owner)
    await parlia.addValidator(validator1, validator1);
    await parlia.addValidator(validator3, validator3);
